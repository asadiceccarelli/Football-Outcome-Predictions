...
def initial_data_pipeline():
    ...
    create_cleaned_dataset(main_df).to_csv('preparation/dataframes/cleaned_dataset.csv')
    upload_initial_data()
...
def additional_data_pipeline(dataset_path, elo_path):
    ...
    create_cleaned_dataset(main_df_additional).to_csv('preparation/dataframes/cleaned_dataset_additional.csv')
